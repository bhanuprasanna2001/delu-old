  ...
  return <main className="detail-page sources-page">
    ...
    <section className="source-section" aria-labelledby="delu-processing">
      ...
      <div className="source-copy">
        ...
        <p>Missing source data stays pending and is retried automatically. Weather is fetched when its run becomes available. Published forecasts keep their original values and creation timestamps; evaluation follows once the actual SDAC prices are available.</p>
